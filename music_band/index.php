    ...
    <div class="container-fluid" id="app">
        <div class="header d-flex col-md-12  align-items-center">
            <div class="header_leftbar d-flex justify-content-lg-between align-items-center align-self-center">
                <p class="text_color_black" onclick="LoadHome()" style="font-weight: 800; font-size: 25px;">Music Band</p>
                <img src="images/logo.png" width="27" height="22" alt="" style="transform: rotate(-90deg);">
            </div>
            <div class="header_registration">
              <button onclick="PopUpShow()" class="btn scale_12" style="color: #fff; font-size: 22px;">Registration</button>
              <button onclick="PopupLogin()" class="btn scale_12" style="color: #fff;font-size: 22px;">Autoriz</button>
            </div>
        </div>
        ...
        <div class="slider">
            ...
            <div class="request d-flex ">
              <img src="images/markknopfler.png" alt="" style="width: 746px; height: 348px;" class="ml-5">
              
                <div class="do_req d-flex flex-column align-items-left justify-content-lg-center text-center">
                    <p>Music Band - музыкальный интернет-магазин, основанный  в 2022 году. Более 1000 товаров, из разных уголков мира.</p>
                </div>
